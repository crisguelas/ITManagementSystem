...
export const Sidebar = ({
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed left-0 right-0 top-0 z-40 flex max-h-[85vh] w-full flex-col rounded-b-2xl bg-primary-900 text-white shadow-2xl transition-transform duration-300 md:sticky md:top-0 md:h-screen md:max-h-none md:max-w-none md:rounded-none md:shadow-none md:transition-all md:translate-y-0 md:shrink-0",
